                ...
                <div class="small-breadcrumb">
                    <div class=" breadcrumb-link">
                        <ul>
                            ...
                            <li><a href="<?php echo base_url(); ?>">Featured</a>
                                        ...
                                        <div class="custom-select-box">
                                           <?php
                                            if($this->uri->segment(3) != null){
                                                ?>
                                                <?php echo form_dropdown('sort_types_feature',
                                                    array('date' => 'Date', 'brand' => 'Brand', 'price' => 'Price'),
                                                    $this->uri->segment(3) ,'class="custom-select" id="sort_types_feature"') ?>
                                                <?php
                                            }else{
                                                ?>
                                                <?php echo form_dropdown('sort_types_feature',
                                                    array('date' => 'Date',  'brand' => 'Brand', 'price' => 'Price'),
                                                    '','class="custom-select" id="sort_types_feature"') ?>
                                                <?php
                                            }
                                            ?>
                                        </div>
                                        ...
                                        <li><?php
                                            ...
                                            if($session_array == NULL){
                                                ...
                                                <form action="<?php echo base_url(); ?>user/wishlist" method="POST">
                                                    ...
                                                    <button  class="btn btn-flat btn-sm btn-primary" id="wish_list_btn" type="submit" href="<?php echo base_url(); ?>user/wishlist" title="View Wih List">
                                                        Wish List
                                                        <?php
...
<!--                                                    <a href="tel:--><?php //echo (is_array($company) && count($company) != 0) ? $company[0]->contactno : $property->contact_mobile; ?><!--"><i class="fa fa-phone"></i>&nbsp;&nbsp;--><?php //echo (is_array($company) && count($company) != 0) ? $company[0]->contactno : $property->contact_mobile; ?><!--</a>-->
                                            ...
                                            <div class="clearfix archive-history">
                                                ...
                                                <div class="ad-meta">
                                                    <li style="text-align: right; width: 100%; list-style: none; padding: 0; line-height: 0; margin: 0; margin-top:10px" id="more_info_li">

                ...
                <div class="small-breadcrumb">
                    <div class=" breadcrumb-link">
                        <ul>
                            ...
                            <li><a class="active" href="">Listing - <?php echo ucwords(str_replace('%20', ' ', $model_type_name)); ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                        ...
                                        <ul class="list-unstyled list-inline pull-right" style="min-height: 80px">
                                            ...
                                            <li>
                                                ...
                                                <form action="<?php echo base_url(); ?>user/wishlist" method="POST">
                                                    ...
                                                    <button id="wish_list_btn" class="btn btn-flat btn-sm btn-primary" type="submit" href="<?php echo base_url(); ?>user/wishlist">
                                                         Wish List
                                                        <?php

...
//                                                ?>
<!--                                                --><?php //echo form_dropdown('sort_types_search',
//                                                    array('0' => 'Select', 'brand' => 'Brand', 'date' => 'Date', 'price' => 'Price'),
//                                                    $this->uri->segment(3) ,'class="custom-select" id="sort_types_search"') ?>
<!--                                                --><?php
//                                            }else{
//                                                ?>
<!--                                                --><?php //echo form_dropdown('sort_types_search',
//                                                    array('0' => 'Select', 'brand' => 'Brand', 'date' => 'Date', 'price' => 'Price'),
//                                                    '','class="custom-select" id="sort_types_search"') ?>
<!--                                                --><?php
//                                            }
//                                            ?>
<!--                                        </div>-->
<!--                                    </div>-->
                                ...
                                <div class="col-md-5 col-xs-12 col-sm-5 no-padding" style="margin-top: 3px">
                                    <ul class="list-unstyled list-inline pull-right"  style="min-height: 80px">
                                        <li>
                                            <!--                                            <form action="--><?php //echo base_url(); ?><!--vehicle/compare" method="POST">-->
                                            <!--                                                <input type="hidden" value="" name="compare_array" id="compare_array">-->
                                            <a id="compare_btn"  class="btn btn-flat btn-sm btn-primary" href="<?php echo base_url(); ?>vehicle/compare">
                                                 Compare
                                                <?php
                                                ...
                                                ?>
                                                <span style="" id="compare_count"> (<?php echo count($vehicles); ?>)</span>
                                        ...
                                        <li>
                                            ...
                                            if($session_array == NULL){
                                                ?>
                                                <a id="wish_list_btn" class="btn btn-flat btn-sm btn-primary" href="<?php echo base_url(); ?>login">
                                                     Wish List
                                                ...
                                                <form action="<?php echo base_url(); ?>user/wishlist" method="POST">
                                                    ...
                                                    <button class="btn btn-flat btn-sm btn-primary" id="wish_list_btn" type="submit" href="<?php echo base_url(); ?>user/wishlist">
                                                         Wish List
                                                        <?php
                                        ...
                                        <div class="col-md-4 col-xs-12 col-sm-6">
                                            <div class="category-grid-box-1">
                                                ...
                                                <div class="short-description-1 clearfix">
                                                    ...
                                                    ?>
                                                    <h3><a title=""
                                                           href="<?php echo base_url(); ?>vehicle/view/<?php echo $featured_property->property_id; ?>">
                                                            <?php
...
<?php
                                    ...
                                    ?>
                                                ...
                                                <span style="font-weight: 600; color: #333333;">
                                                    ...
                                                    ?>
                                                        ...
                                                        <br>
                                                        <span style="font-size: 13px;"><i class="fa fa-eye"></i>
                                                            <?php

                                                            $result = $this->PropertyModel->getPostViewCountByPropertyId($featured_property->property_id);
                                                            if(is_array($result) && count($result) != 0){
                                                                echo count($result);
                                                            }else{
                                                                echo "0";
                                                    ...
                                                    <li style="text-align: right; width: 100%; list-style: none; padding: 0; line-height: 0; margin: 0;"
                                                        id="more_info_li">
                                                        <a href="<?php echo base_url(); ?>vehicle/view/<?php echo $featured_property->property_id; ?>">More
                                                            Info >></a>
                                                    </li>
                                                </div>
                                                <?php
                                                ...
                                                <div class="ad-info-1">
                                                    <div class="ad-meta" id="list_contact_no" style="background: none">
                                                        <!--                                                        <a href="tel:-->
                                                        <?php //echo (is_array($company) && count($company) != 0) ? $company[0]->contactno : $property->contact_mobile; ?><!--"><i class="fa fa-phone"></i>&nbsp;&nbsp;-->
                                                        <?php //echo (is_array($company) && count($company) != 0) ? $company[0]->contactno : $property->contact_mobile; ?><!--</a>-->
                                                    </div>
                                                    <ul class="pull-right">
                                                        <li>
                                                            <a class="addButtonCompare"  id="com_<?php echo $featured_property->property_id; ?>">
                                                                <input type="hidden" name="property[1].id"
                                                                       value="<?php echo $featured_property->property_id; ?>"/>
                                                                <!--                                                        Compare-->
                                                                <!--                                                        <input type="hidden" name="property[1].name" value="-->
                                                                <?php //echo $featured_property->title; ?><!--" />-->
                                                                <img id="compare_img"
                                                                     src="<?php echo base_url(); ?>assets/images/regi/compare.png"
                                                                     width="24px" title="Click to Compare">
                                                            </a>
                                                        </li>
                                                    ...
                                                    <ul class="pull-right">
                                                        <li>
                                                            <a class="addButton">
                                                                ...
                                                                <img id="fav_img"
                                                                     src="<?php echo base_url(); ?>assets/images/regi/favourite.png"
                                                                     width="24px" title="Add to Wish List">
                                                                <!--                                                    Add to Wish List-->
                                                            </a>
                                                        </li>
                                                    </ul>
                                    ...
                                    <div style="padding: 15px; background-color: #999999; color: #ffffff; font-size: 19px; font-weight: 600">
                                    <?php

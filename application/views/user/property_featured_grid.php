                ...
                <div class="small-breadcrumb">
                    <div class=" breadcrumb-link">
                        <ul>
                            ...
                            <li><a href="<?php echo base_url(); ?>">Featured</a></li>
                            <li><a class="active" href="<?php echo base_url(); ?>">Grid</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="listingTopFilterBar">
                                    <div class="col-md-4 col-xs-12 col-sm-6 no-padding">
                                        <ul class="filterAdType">
                                            <?php
                                            if($this->uri->segment(2) == "featured_grid"){
                                                ?>
                                                <li><a href="<?php echo base_url(); ?>vehicle/featured"><span class="fa fa-bars"></span>&nbsp;List</a> </li>
                                                <li class="active"><a href="<?php echo base_url(); ?>vehicle/featured_grid"><span class="fa fa-th"></span>&nbsp;Grid</a> </li>
                                                <?php
                                            }else{
                                                ?>
                                                <li class="active"><a href="<?php echo base_url(); ?>vehicle/featured"><span class="fa fa-bars"></span>&nbsp;List</a> </li>
                                                <li class=""><a href="<?php echo base_url(); ?>vehicle/featured_grid"><span class="fa fa-th"></span>&nbsp;Grid</a> </li>
                                                <?php
                                            }
                                        ...
                                        <div class="header-listing">
                                            ...
                                            <div class="custom-select-box">
                                                ...
                                                if($this->uri->segment(3) != null){
                                                    ?>
                                                    <?php echo form_dropdown('sort_types_feature_grid',
                                                        array('date' => 'Date', 'brand' => 'Brand', 'price' => 'Price'),
                                                        $this->uri->segment(3) ,'class="custom-select" id="sort_types_feature_grid"') ?>
                                                    <?php
                                                }else{
                                                    ?>
                                                    <?php echo form_dropdown('sort_types_feature_grid',
                                                        array('date' => 'Date', 'brand' => 'Brand', 'price' => 'Price'),
                                                        '','class="custom-select" id="sort_types_feature_grid"') ?>
                                                    <?php
                                                }
                                                ?>
                                            </div>
                                            ...
                                            <li><?php
                                                ...
                                                if($session_array == NULL){
                                                    ...
                                                    <form action="<?php echo base_url(); ?>user/wishlist" method="POST">
                                                        ...
                                                        <button class="btn btn-flat btn-sm btn-primary" id="wish_list_btn" type="submit" href="<?php echo base_url(); ?>user/wishlist" title="View Wish List">

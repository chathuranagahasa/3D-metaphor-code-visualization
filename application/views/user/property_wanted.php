                ...
                <article class="blog-details">
                    <div class="article-desc bg-1">
                        ...
                        <div class="post-title">
                            <h4 style="font-weight: 600 !important;">Add Property - Wanted</h4>
                            <?php
                        ...
                        <div class="post-content" id="property-add-form">
                            ...
                            <?php
                            $form = array(
                                'name' => 'property_wanted_save',
                                'id' => 'property_wanted_save'
                            );
                            echo form_open_multipart('property/store_property_wanted', $form) ?>
                            ...
                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="profile-top-form">
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <div class="input-type">
                                                            ...
                                                            <?php echo form_dropdown('pro_property_type',
                                                                $main_properties,
                                                                set_value('pro_property_type'),'class="form-control" id="pro_property_type" ') ?>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <div class="input-type">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <div class="input-type">
                                                            <label>Title</label>
                                                            <input type="text" name="property_title" id="property_title" value="<?php echo set_value('property_title'); ?>" class="form-control" placeholder="Eg : 2 Bed Room Apartment with Sea View">
                                                        </div>
                                                    </div>
                                                    <div class="profile-top-form-bottom">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <div class="input-type">
                                                                ...
                                                                <textarea onkeyup="countChar(this)" name="textarea-desc-property" id="textarea-desc-property"><?php echo set_value('textarea-desc-property'); ?></textarea>
                                                            </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="update-profile-submit">
                                        <button type="submit">Post Your Ad Now</button>
                                    </div>
                                </div>
                            </div>
                            </form>

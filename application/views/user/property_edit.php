                    ...
                    <article class="blog-details">
                        <div class="article-desc bg-1">
                            ...
                            <div class="post-content" id="property-add-form">
                                ...
                                echo form_open_multipart('vehicle/update_vehicle', $form) ?>
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <div class="input-type">
                                                                ...
                                                                <?php echo form_dropdown('pro_property_brand',
                                                                    $models,
                                                                    (count($property) != 0) ? $property[0]->brand : null,'class="selectpicker form-control" id="pro_property_brand" disabled') ?>
                                                                <input type="hidden" name="pro_property_brand" value="<?php echo $property[0]->brand; ?>">
                                                            </div>
                                                        </div>
<!--                                                        <div class="col-md-12 col-sm-12 col-xs-12">-->
<!--                                                            <div class="input-type">-->
...
<!--                                                        </div>-->
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <div class="input-type">
                                                                <label>Model</label>
                                                                <input type="text" name="property_model" readonly id="property_model" value="<?php echo (count($property) != 0) ? $property[0]->model : null; ?>" class="form-control" placeholder="Eg :  BMW M3 Sedan.">
                                                            </div>
                                                        </div>
...
<!--                                                            </div>-->
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="update-profile-submit">
                                            <button class="btn btn-warning" type="submit">Update Your Ad Now</button>
                                        </div>
                                    </div>
                                </div>
                                </form>

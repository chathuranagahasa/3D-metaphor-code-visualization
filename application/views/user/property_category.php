                ...
                <div class="small-breadcrumb">
                    <div class=" breadcrumb-link">
                        <ul>
                            ...
                            <li><a href="<?php echo base_url(); ?>"><?php echo ucwords($model_type_name); ?></a>
                                        ...
                                        <li><?php
                                            ...
                                            if($session_array == NULL){
                                                ...
                                                <form action="<?php echo base_url(); ?>user/wishlist" method="POST">
                                                    ...
                                                    <button class="btn btn-flat btn-sm btn-primary" id="wish_list_btn" title="View Wish List" type="submit" href="<?php echo base_url(); ?>user/wishlist">

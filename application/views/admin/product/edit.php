...
<section class="content">
    ...
    <div class="panel-heading clearfix" style="background-color: #823168">
        <h4 class="panel-title" style=" color: #FFFFFF;">Update - Property</h4>
    </div>
                ...
                <article class="blog-details">
                    <div class="article-desc bg-1" style="background-color: #ffffff !important;">
                        ...
                        <div class="post-content" id="property-add-form">
                            ...
                            echo form_open_multipart('admin/update_property', $form) ?>
                                        ...
                                        <div class="profile-desc">
                                            <div class="row">
                                                <div class="profile-top-form">
                                                    <?php
                                                    if((is_array($property) && $property[0]->car_sale_id == "") || (is_array($property) && $property[0]->car_sale_id == 0)){
                                                        ?>
                                                    <div class="row" style="border:1px solid #CCCCCC; background: #fdfdfd; padding: 20px">
                                                        <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 0 !important; padding-right: 0 !important; padding-top: 15px">
                                                            <p style="text-decoration: underline; font-size: 18px; font-weight: 800">Customer Information</p>
                                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 0 !important; padding-right: 0 !important; margin-top: 15px">
                                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                                    <div class="input-type">
                                                                        <label>Name</label>
                                                                        <input type="text" name="car_sale_name" id="car_sale_name" value="<?php echo (count($property) != 0) ? $property[0]->contact_name : null; ?>" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                                    <div class="input-type">
                                                                        <label>Contact No</label>
                                                                        <input type="text" name="car_sale_contactno" id="car_sale_contactno" value="<?php echo (count($property) != 0) ? $property[0]->contact_email : null; ?>" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 col-sm-6 col-xs-12" style="margin-top: 10px">
                                                                    <div class="input-type">
                                                                        <label>Address</label>
                                                                        <input type="text" name="car_sale_address" id="car_sale_address" value="<?php echo (count($property) != 0) ? $property[0]->contact_mobile : null; ?>" class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        <?php
                                                                ...
                                                                <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 0 !important; padding-right: 0 !important; padding-top: 15px">
                                                                    ...
                                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                                        <div class="input-type">
                                                                            ...
                                                                            <input type="hidden" name="car_sale_select" id="car_sale_select" value="<?php echo (count($property) != 0) ? $property[0]->car_sale_id : null; ?>">
                                                                            <?php echo form_dropdown('car_sale_select',
                                                                                $car_sales,
                                                                                (count($property) != 0) ? $property[0]->car_sale_id : null,'class="selectpicker form-control" data-live-search="true" id="car_sale_select" disabled') ?>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 0 !important; padding-right: 0 !important; margin-top: 15px">
                                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="row" style="border:1px solid #CCCCCC; background: #fdfdfd; padding: 20px; margin-top: 20px">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 0 !important; padding-right: 0 !important; display: none">
                                                            <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 0 !important; padding-right: 0 !important; margin-top: 10px">
                                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                                    <div class="input-type">
                                                                        <label>Ref ID</label>
                                                                        <input type="text" name="pro_refid" id="pro_refid" readonly value="<?php echo $property[0]->ref_id; ?>" class="form-control">
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 0 !important; padding-right: 0 !important; padding-top: 15px">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12" style="">
                                                            <div class="input-type">
                                                                <input type="hidden" name="pro_sub_body_type_id" id="pro_sub_body_type_id" value="<?php echo (count($property) != 0) ? $property[0]->sub_body_type : null; ?>" class="form-control">
                                                                <?php

                                                                $sub_body_d = $this->PropertyModel->getCategoryDetailsByNativeId($property[0]->sub_body_type);

                                                                ?>
                                                                <input type="hidden" name="pro_sub_body_type_name" id="pro_sub_body_type_name" value="<?php echo (is_array($sub_body_d) && count($sub_body_d) != 0) ? $sub_body_d[0]->name : null; ?>" class="form-control">
...
//                                                                    (count($property) != 0) ? $property[0]->brand : null,'class="selectpicker form-control" id="pro_brand" ') ?>
                                                                ...
                                                                <?php
                                                                $brandName = $this->PropertyModel->getBrandNameById($property[0]->brand);
                                                                ...
                                                                <select name="pro_brand" id="pro_brand" class="form-control">
                                                                    ...
                                                                    <optgroup label="Top Brands">
                                                                        <?php
                                                                        if(is_array($modelTop) && count($modelTop) != 0){
                                                                            ?>
                                                                            <option selected value="<?php echo (count($property) != 0) ? $property[0]->brand : null; ?>"><?php echo (count($modelTop) != 0) ? $modelTop[0]->name : null; ?></option>
                                                                        <?php
                                                                        }
                                                                        ?>
                                                                    ...
                                                                    <optgroup label="Brands">
                                                                        <?php
                                                                        if(is_array($brandName) && count($brandName) != 0){
                                                                        ?>
                                                                        <option selected value="<?php echo (count($property) != 0) ? $property[0]->brand : null; ?>"><?php echo (count($brandName) != 0) ? $brandName[0]->name : null; ?></option>
                                                                            <?php
                                                                        }
                                                                        ?>
...
//                                                                    (count($property) != 0) ? $property[0]->model : null,'class="selectpicker form-control" id="pro_model" ') ?>
                                                                ...
                                                                <?php
                                                                $modelD = $this->PropertyModel->getModelNameById($property[0]->model);

                                                                ?>
                                                                <input type="hidden" name="pro_model_seleted" id="pro_model_seleted" readonly value="<?php echo $property[0]->model; ?>" class="form-control">
                                                                <input type="hidden" name="pro_model_seleted_name" id="pro_model_seleted_name" readonly value="<?php echo (is_array($modelD) && count($modelD) != 0) ? $modelD[0]->name : null; ?>" class="form-control">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <div class="input-type">
                                                                    ...
                                                                    <?php echo form_dropdown('pro_district',
                                                                        $districts,
                                                                        ((count($property) != 0) ? $property[0]->district : null),'class="selectpicker form-control"  data-live-search="true" id="pro_district" ') ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 0 !important; padding-right: 0 !important; margin-top: 15px">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <div class="input-type">
                                                                    ...
                                                                    <!--
                                                                    <input type="text" name="property_door_count" id="property_door_count" value="<?php //echo ((count($property) != 0) ? $property[0]->door_count : null ); ?>" class="form-control" placeholder="Eg :  4."> -->
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 0 !important; padding-right: 0 !important; margin-top: 15px">
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12" style="padding-left: 0 !important; padding-right: 0 !important; margin-top: 15px">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <div class="input-type">
                                                                ...
                                                                if($property[0]->main_image != null){
                                                                    ?>
                                                                    <img src="<?php echo base_url(); ?>assets/uploads/<?php echo $property[0]->main_image; ?>" width="20%" style="margin: 10px">
                                                                    <a id="close" href="<?php echo base_url(); ?>/admin/delete_main_image/<?php echo $property[0]->property_id; ?>"></a>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </div>
                                                     ...
                                                     <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 40px; margin-top: 30px">
                                                        <div class="input-type">
                                                            ...
                                                            ?>
                                                            <input type="hidden" id="user_id" name="user_id" value="<?php echo (count($property) != 0) ? $property[0]->user_id : null; ?>">
                                                                        ...
                                                                        <li class="fileuploader-item file-type-image file-ext-jpg upload-failed" style="padding-bottom: 25px !important;">
                                                                            ...
                                                                            <div class="columns"><div class="column-thumbnail">
                                                                                ...
                                                                                <div class="column-actions">
                                                                                    <a href="<?php echo base_url()."admin/removePropertyImage/".$image->id."/". $property[0]->property_id; ?>" class="fileuploader-action fileuploader-action-remove" title="Remove">
                                                                                        <i></i>
                                                                                    </a>
                                                                                </div>
                                                                            </div>
...
<!--                                                </div>-->
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="">
                                        <button class="btn btn-flat btn-warning btn-lg" type="submit" style="margin-top:10px;border: none; color: #FFF;">Update Ad</button>
                                    </div>
                                </div>
                            </div>
                            </form>

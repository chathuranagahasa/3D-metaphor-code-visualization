...
<section class="content">
    <div class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="active">Delete Property - Wanted</li>
        </ol>
    </div>
    <div class="panel-heading clearfix" style="background-color: #823168">
        <h4 class="panel-title" style=" color: #FFFFFF;">Delete - Wanted Property</h4>
    </div>
                        ...
                        <article class="blog-details">
                            <div class="article-desc bg-1" style="background-color: #ffffff !important;">
                                ...
                                <div class="post-content" id="property-add-form">
                                    ...
                                    echo form_open_multipart('admin/delete_property_wanted', $form) ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="update-profile-submit">
                                                <button type="submit" style="border:none; margin-top: 10px;padding: 10px; color: #ffffff">Delete Ad</button>
                                            </div>
                                        </div>
                                    </div>
                                    </form>

...
<section class="content">
    ...
    <div class="panel-heading clearfix" style="background-color: #a23c81">
        <h4 class="panel-title" style=" color: #FFFFFF;">Update - Model</h4>
    </div>
                    ...
                    <!-- general form elements -->
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-sm-4">
                                    <?php echo form_dropdown('model_type',
                                        ...
                                        'normal','class="selectpicker form-control"  data-live-search="true" id="model_type" ') ?>
                                </div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-sm-4">
                                <input value="<?php echo $model[0]->id; ?>" class="form-control" name="id" type="hidden" id="id"/>
                                    <input value="<?php echo $model[0]->name; ?>" class="form-control" name="model_id" type="text" id="model_id"/>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-xs-4">
                                    <input value="<?php echo $model[0]->name; ?>" class="form-control" type="text" name="model_name" id="model_name">
                                </div>
                                <label class="col-sm-12 control-label"></label>
                            </div>

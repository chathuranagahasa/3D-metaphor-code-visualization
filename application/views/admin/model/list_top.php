                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <h3><b>Top Models</b></h3>
                                            <table aria-describedby="example_info" role="grid" id="admin-user-list-table-2" class="display table table dataTable" style="width: 100%;">
                                                <thead>
                                                <tr role="row">
                                                ...
                                                <tbody>
                                                <?php
                                                foreach($topModelList as $index => $model){
                                                    ?>
                                                    <tr class="{{ $index%2 == 0 ?'odd' : 'even'}}" role="row">

                                                        <td>
                                                            <?php echo sprintf("%03d", $model->model_id); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $model->name; ?>
                                                        </td>
                                                        <td>
                                                            <a href="<?php echo base_url().'admin/update_top_model/'.$model->model_id; ?>"><span class="label label-warning">Edit</span></a>
                                                        </td>
                                                        <td>
                                                            <a href="<?php echo base_url().'admin/delete_top_model/'.$model->model_id; ?>"><span class="label label-danger">Delete</span></a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }

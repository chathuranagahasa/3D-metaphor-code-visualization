...
<section class="content">
    ...
    <div class="panel-heading clearfix" style="background-color: #da251d">
        <h4 class="panel-title" style=" color: #FFFFFF;">Delete - Category</h4>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        echo form_open_multipart('Admin/deleteCategoryDetails', $form) ?>
                        <!--  <form role="form" > -->
                        <?php

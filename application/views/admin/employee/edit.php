...
<section class="content">
    ...
    <div class="panel-heading clearfix" style="background-color: #337ab7">
        <h4 class="panel-title" style=" color: #FFFFFF;">Edit - Employee</h4>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        echo form_open('User/updateEmployee', $form) ?>
                        <!--  <form role="form" > -->
                        <div class="box-body">
...
<?php //var_dump($emp_details[0]->bp_location); ?>
                                    <?php echo form_dropdown('emp_bplocation',
                                        $bp_locations,
                                        $emp_details[0]->bp_location,'class="form-control" id="emp_bplocation"') ?>
                            ...
                            <div class="form-horizontal">
                               <label class="col-sm-2 control-label" for="emp_fname"> First Name </label>
                                <div class="col-xs-4">
                                    <input class="form-control" type="text" value="<?php echo $emp_details[0]->first_name; ?>" name="emp_fname" id="emp_fname">
                                </div>
                                <div class="error_msg"></div>
                                <label class="col-sm-2 control-label" for="emp_lname"> Last Name </label>
                                <div class="col-xs-4">
                                    <input class="form-control" type="text" value="<?php echo $emp_details[0]->last_name; ?>" name="emp_lname" id="emp_lname">
                                </div>
                                <label class="col-sm-12 control-label"></label>
                            </div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control" name="emp_nic" value="<?php echo $emp_details[0]->nic; ?>" type="text" id="emp_nic"/>
                                </div>
                           </div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-xs-4">
                                    <?php echo form_dropdown('emp_designation',
                                        $designations,
                                        $emp_details[0]->designation,'class="form-control" id="emp_designation"') ?>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control" type="text" value="<?php echo $emp_details[0]->dob; ?>" name="emp_bdate" id="emp_bdate" data-language='en'>
                                </div>
                                ...
                                <div class="col-xs-4">
                                    <?php echo form_dropdown('emp_status',
                                        $civil_status,
                                        $emp_details[0]->status,'class="form-control" id="emp_status"') ?>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-xs-4">
                                    <?php echo form_dropdown('emp_noofchild',
                                        ...
                                        $emp_details[0]->noofchild,'class="form-control" id="emp_noofchild"') ?>
                                </div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control" value="<?php echo $emp_details[0]->insurance_id; ?>" type="text" name="emp_insuid" id="emp_insuid">
                                </div>

                                <label class="col-xs-2 control-label" for="emp_insu_issuedate"> Issued Date </label>
                                <div class="col-xs-4">
                                    <input class="form-control" value="<?php echo $emp_details[0]->insu_issue_date; ?>" type="text" name="emp_insu_issuedate" id="emp_insu_issuedate" data-language='en'>
                                </div>
                                <label class="col-sm-12 control-label"></label>

                                <label class="col-xs-2 control-label" for="emp_insu_expdate"> Expire Date </label>
                                <div class="col-xs-4">
                                    <input class="form-control" value="<?php echo $emp_details[0]->insu_expire_date; ?>" type="text" name="emp_insu_expdate" id="emp_insu_expdate" data-language='en'>
                                </div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control" value="<?php echo $emp_details[0]->passport_no; ?>" type="text" name="emp_passport" id="emp_passport">
                                </div>

                                <label class="col-xs-2 control-label" for="emp_insuid"> Issued Date </label>
                                <div class="col-xs-4">
                                    <input class="form-control" value="<?php echo $emp_details[0]->passport_issue_date; ?>" type="text" name="emp_passport_issuedate" id="emp_passport_issuedate" data-language='en'>
                                </div>
                                <div class="error_msg"></div>
                                <label class="col-sm-12 control-label"></label>
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control" value="<?php echo $emp_details[0]->passport_expire_date; ?>" type="text" name="emp_passport_expiredate" id="emp_passport_expiredate" data-language='en'>
                                </div>
                                <hr>
                                <label class="col-sm-12 control-label" style="margin-bottom: 20px"></label>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-xs-4">
                                    <?php echo form_dropdown('emp_shirtsize',
                                        ...
                                        $emp_details[0]->shirt_size,'class="form-control" id="emp_shirtsize"') ?>
                                </div>
                                <div class="error_msg"></div>
                                ...
                                <div class="col-xs-4">
                                    <?php echo form_dropdown('emp_teeshirtsize',
                                        ...
                                        $emp_details[0]->tshirt_size,'class="form-control" id="emp_teeshirtsize"') ?>
                                </div>
                                <label class="col-sm-12 control-label"></label>
                            </div>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control" type="text" value="<?php echo $emp_details[0]->date_join; ?>" name="emp_dateofjoin" id="emp_dateofjoin" data-language='en'>
                                </div>
                        ...
                        <div class="box-footer">
                            <button type="submit" name="sub_employee_edit" id="sub_employee_edit" class="btn btn-warning btn-flat" style="padding-left:50px; padding-right:50px; margin-bottom : 20px">Update</button>

...
<div class="col-lg-12">
    ...
    <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 10px">Hi <?php echo ucwords($name); ?>,</p>
    <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 14px;line-height: 20px;Margin-bottom: 20px">
        We are delighted to let you know your listing is now online at LankaResidence.com
    </p>
    ...
    <img class="col-lg-offset-5" style="border: 0;-ms-interpolation-mode: bicubic;max-width: 400px" src="<?php echo base_url(); ?>/assets/img/logo_new.png" alt=""></div>
<div class="col-lg-12" style="margin-top: 20px">
    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
        <p><?php echo (count($property) != 0) ? $property['title'] : null ?></p>
        <p><?php echo (count($property) != 0) ? $property['description'] : null ?></p>
        <p><?php echo (count($property) != 0) ? $property['phone_mobile'] : null ?></p>
    </div>
</div>
<div class="col-lg-12" style="margin-top: 20px">
    <p>Your Subscription Start Date : <?php echo (count($property) != 0) ? $property['posted_date'] : null ?></p>
    <p>Your Subscription End Date :  <?php echo (count($property) != 0) ? $property['expire_date'] : null ?></p>
</div>
